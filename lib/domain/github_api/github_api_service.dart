...
final githubRepositoryServiceProvider =
    Provider((ref) => GitHubApiService());
...
class GitHubApiService {
  ...
  Future<List<GitHubRepository>> searchRepositories({
    ...
    final response = await http.get(Uri.parse('https://api.github.com/search/repositories?q=$searchWord&sort=stars&order=desc'));
